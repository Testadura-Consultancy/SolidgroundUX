...
## 8.6 Script metadata (identity) ------------------------------------------------------

## 8.7 Script metadata (framework integration) -----------------------------------------

### 8.7.1 Variable: `SGND_USING`
...
## 8.8 Example: Arguments

### 8.8.1 Variable: `SGND_SCRIPT_EXAMPLES`
...
### 8.8.2 Variable: `SGND_SCRIPT_GLOBALS`
...
### 8.8.3 Variable: `SGND_STATE_VARIABLES`
...
### 8.8.4 Variable: `SGND_ON_EXIT_HANDLERS`
...
## 8.9 Local script Declarations -------------------------------------------------------

## 8.10 local script functions ----------------------------------------------------------tree

## 8.11 Manifests

## 8.12 Main sequence  

### 8.12.1 Function: `_perm_resolve()`
...
### 8.12.2 Function: `_update_lastdeployinfo()`
...
### 8.12.3 Function: `_getparameters()`
...
## 8.14 Interactive mode -------------------------------------------------------

## 8.15 Source root --------------------------------------------------------

## 8.16 Target root --------------------------------------------------------

### 8.16.1 Function: `_deploy()`
...
## 8.19 Handle builtin arguments

## 8.20 UI

## 8.21 Main script logic

...
#   Version     : 1.9
#   Build       : 2622203
#   Checksum    : 10784b192322116efd9afc091bd71b795a4968d993acff5c8e3117bdc54a54fe
#   Source      : 20-menu-active-directory.sh
#   Type        : module
...
set -uo pipefail
    ...
    _sgnd_console_profile_source_part "20-active-directory.sh" || return $?

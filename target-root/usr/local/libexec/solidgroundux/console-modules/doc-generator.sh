...
#   Version     : 1.5
#   Build       : 2619012
#   Checksum    : 34b5c706b730d1193e345b7014d4bc2c3ef7bc3ff4d6825fcd3825652d426919
...
# --- Local script functions ----------------------------------------------------------
    ...
    # fn: _summary - Print documentation generation summary
        ...
        #   _summary
    _summary() {
        local elapsed=$(( _process_end - _process_start ))
        ...
        sgnd_print 
        sgnd_print processing started at: $(date -d "@$_process_start" +"%Y-%m-%d %H:%M:%S")
        sgnd_print processing ended at: $(date -d "@$_process_end" +"%Y-%m-%d %H:%M:%S")
        sgnd_print elapsed time: $(( elapsed / 60 )) minutes $(( elapsed % 60 )) seconds
        sgnd_print
...
# --- Main ---------------------------------------------------------------------------
    ...
    main() {
        ...
        sgnd_print "Testadura SolidGroundUX Documentation Generator"
        sgnd_print "Version: ${SGND_VERSION:-unknown}"
        sgnd_print "Build: ${SGND_BUILD:-unknown}"
        local start_time
        local display_time
        start_time="$(date +%s)"

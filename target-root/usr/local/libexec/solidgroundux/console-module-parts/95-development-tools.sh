...
#   Version     : 1.9
#   Build       : 2622216
#   Checksum    : a6e41c1f80df521f690eda18ede17fa707212bf313ebf18243701b7dcdb3b0c3
...
# - Module metadata -------------------------------------------------------------
    ...
    SGND_DEVELOPMENT_TOOLS_MODULE_DESC="Workspace creation, deployment, release preparation, wrapper generation, and documentation tools"
...
# - Developer tool actions -------------------------------------------------------
    ...
    # fn: _exe_createwrappers
        # . Returns
        #   Exit status of sgnd-create-wrappers.
        # . Usage
        #   _exe_createwrappers
    _exe_createwrappers() {
...
# - Console registration ---------------------------------------------------------
    ...
    sgnd_console_register_item "wrappers" "$SGND_DEVELOPMENT_TOOLS_MODULE_ID" "Create wrappers" "_exe_createwrappers" "Create root-aware bin or sbin wrappers for selected scripts" 0 15 1
